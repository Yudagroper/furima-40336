...
ActiveRecord::Schema[7.0].define(version: 2024_03_15_024957) do
  ...
  create_table "buys", charset: "utf8", force: :cascade do |t|
    ...
    t.index ["receipt_id"], name: "index_buys_on_receipt_id"
  end
  ...
  create_table "markets", charset: "utf8", force: :cascade do |t|
  ...
  create_table "receipts", charset: "utf8", force: :cascade do |t|
    t.bigint "market_id", null: false
    t.bigint "user_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["market_id"], name: "index_receipts_on_market_id"
  ...
  add_foreign_key "buys", "receipts"
  add_foreign_key "markets", "users"
  add_foreign_key "receipts", "markets"
